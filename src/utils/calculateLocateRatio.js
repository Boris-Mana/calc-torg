// realtyType, 
export default function calculateLocateRatio(year, region, purpose, intervalType, minMaxMid) {
    let res;

    // console.log('В выбор коэфф:', year, region, purpose, intervalType, minMaxMid);
    ...
    const getDovInterval = () => {        
        if (year === '01.01.2023') {
            ...
            console.log('Не прошло отбор по данным. "Нет данных"');
            res = 'н/д'
        }
        // return res
    };
